...
# Initialize required elements/environment
        ...
        # Bird and pipe init
        bird_img = pygame.image.load("img2/bird_sprite.png")
        bird_img = pygame.transform.scale(bird_img, (bird_img.get_width() / 8, bird_img.get_height() / 8))
        bird_frame = bird_img.get_rect()
        bird_frame.center = (window_size[0] // 6, window_size[1] // 2)
        pipe_frames = deque()
        pipe_img = pygame.image.load("img2/pipe_sprite_single.png")
        ...
        with mp_face_mesh.FaceMesh(
            ...
            while True:
                ...
                if pipeSpawnTimer == 0:
                    ...
                    top.x= window_size[0]
                    top.y = random.randint( 120-1000,window_size[1] - 120 - space_between_pipes - 870 )
                    bottom = pipe_starting_template.copy()
                    bottom.x, bottom.y = window_size[0], top.y + 870 + space_between_pipes
